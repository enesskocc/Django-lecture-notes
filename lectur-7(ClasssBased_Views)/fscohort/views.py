...
class StudentListView(ListView):
    model = Student
    # context_object_name = 'students' --> ##Studen_list kismina object_list yazarsak bunu yazmaya gerek yok!
    # template_name = "fscohort/student_list.html" --> biz klasörü buna göre uygun olusturdugumuz iicn bunu yaazmaya gerek yok!
