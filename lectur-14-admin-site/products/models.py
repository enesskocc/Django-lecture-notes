...
class Product(models.Model):
    ...
    slug = models.SlugField(null=True, blank=True) ## mesala views.py'da id ile cagiriyorduk fakar best practice slug ile cagirmak!
    ...
    def how_many_reviews(self): ## sadece admin paneli ilgilendiyorsa, orayada eklenwebilir. Ama projenin her yerinde kullanicaksam, buraya eklenmeli.
