...
class StudentCRUD(ModelViewSet):
    ...
    filterset_fields = ['first_name', 'last_name', 'number'] # for DjangoFilterBackend (equal)
    filter_backends = [DjangoFilterBackend, SearchFilter, OrderingFilter]
    search_fields = ['first_name', 'last_name'] # for SearchFilter (contains) use search=value
    ordering_fields = ['first_name', 'last_name'] # for Ordering.
...
'''
## bunun yerine 109. satirdaki yeterli!
